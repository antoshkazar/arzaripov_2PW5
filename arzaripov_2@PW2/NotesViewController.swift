...
//  arzaripov_2PW3
//
//  Created by Anton Zaripov on 05.10.2022.
//
...
final class NotesViewController: UIViewController {
    ...
    private var dataSource = [ ShortNote(text: "The Potters, that's right"), ShortNote(text: "their son, Harry"),
    ShortNote(text: "he is a nice one") ]
